...
export const MSTEAMS_AGENT_TASK_TOOL = {
    ...
    description: "Hand a long-running task to the OpenClaw agent to complete in the background. " +
    ...
    parameters: {
        ...
        properties: {
            task: {
                type: "string",
                description: "The task to perform, described in full so the background agent can complete it unattended.",
            },
            deliverVia: {
                type: "string",
                enum: ["message", "call"],
                description: 'How to deliver the result: "message" (default) sends a Teams chat message; "call" places a Teams call back to the caller and speaks the result.',
            },
        },
        required: ["task"],
    },
...
export const MSTEAMS_LOOK_TOOL = {
    ...
    description: "Look at what the caller is currently showing on the Teams call — their shared screen or " +
    ...
    parameters: {
        ...
        properties: {
            scope: {
                type: "string",
                enum: ["live", "history"],
                description: '"live" (default) looks at the current frame; "history" reviews keyframes from earlier in the call.',
            },
            question: {
                type: "string",
...
export const MSTEAMS_MINUTES_TOOL = {
    ...
    description: "Post written minutes of this call SO FAR (key points, decisions, action items) to the Teams " +
...
export const MSTEAMS_POST_CHAT_TOOL = {
    type: "function",
    name: MSTEAMS_POST_CHAT_TOOL_NAME,
    description: "Post a text message into the Teams chat for THIS call, while the call is still going. Use when " +
...
export const MSTEAMS_SHOW_TOOL = {
    type: "function",
    name: MSTEAMS_SHOW_TOOL_NAME,
    description: "Show the caller an image on the video call — take a screenshot of your screen, or display an " +
